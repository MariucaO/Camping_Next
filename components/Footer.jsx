      ...
      <FramedSection>
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-sm font-sans text-[var(--foreground)] font-medium">
                ...
                <li className="flex flex-col gap-4 items-center md:items-start">
                  <a href="tel:+40752223869" className="flex items-center gap-3 hover:text-[var(--accent)] transition-colors group">
                    <FiPhone className="text-[var(--accent)] text-lg" />
                    <span>0752 223 869</span>
                  </a>
                  <a href="tel:+40730701781" className="flex items-center gap-3 hover:text-[var(--accent)] transition-colors group">
                    <FiPhone className="text-[var(--accent)] text-lg" />
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center md:justify-start gap-8 text-[var(--foreground)]">
                <a href="#" className="text-2xl hover:text-[var(--accent)] transition-all transform hover:-translate-y-1">
                  <FiInstagram />
                </a>
                <a href="#" className="text-2xl hover:text-[var(--accent)] transition-all transform hover:-translate-y-1">
                  <FiFacebook />
          ...
          <div className="mt-20 pt-8 border-t border-[var(--foreground)]/10 text-center text-[var(--foreground)] text-[11px] uppercase tracking-[3px] font-bold">
            <p>© {new Date().getFullYear()} Grădina cu flori Brezoi.</p>
          </div>
        </div>
      </FramedSection>
    </footer>
